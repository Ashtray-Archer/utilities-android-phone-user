...
This is a deliberately small Android input method with twenty character keys:
...
The pull-request workflow compiles the exact twenty-key contract, builds and signs the
